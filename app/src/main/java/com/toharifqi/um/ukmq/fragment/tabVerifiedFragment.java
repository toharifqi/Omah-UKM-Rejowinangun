 ...
 */
public class tabVerifiedFragment extends Fragment implements IFirebaseLoadDonePayment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tab_verified, container, false);

        query = FirebaseDatabase.getInstance().getReference("payments").orderByChild("status").equalTo("paid");
